...
echo ""
echo -e $white" ==========================================="
echo -e $cyan"  Drac0s Linux Chroot Simple Script"
echo -e $white" ==========================================="
echo -e $red"   Main Menu : "
echo
echo -e $white	"$okegreen	1) $white Chroot Versi 1  $okegreen By Blackbutterfly"
echo -e $white	"$okegreen 	2) $white Chroot Versi 2 $okegreen  By eLCrush"
echo -e $white  "$okegreen       3) $white exit"
echo -e $red" =============================================================================="
echo -e $white"   AUTHOR : Blackbutterfly [Purnomo Hadi] | eLCrush [Rifqi Hidayatulloh]"
echo -e $red" =============================================================================="
echo -n -e $cyan"root@chroot:$red "; 
read pilihan
if test $pilihan == '1'
	then
	echo "Create directory of chroot ( /mnt/dir )? "
	read sdx
	export LFS=/mnt/lfs
	mount /dev/$sdx $LFS
